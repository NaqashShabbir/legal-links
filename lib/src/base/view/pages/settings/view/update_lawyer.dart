...
class UpdateLawyerProfileScreen extends StatefulWidget {
  ...
  const UpdateLawyerProfileScreen({super.key});

  @override
  State<UpdateLawyerProfileScreen> createState() => _UpdateLawyerProfileState();
}

class _UpdateLawyerProfileState extends State<UpdateLawyerProfileScreen> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  for (int index = 0;
                      ...
                      index++) ...[
                    practiceField(
                        practiceAreaList[index], index, 'Practice Areas'),
                    h0P8,
                  ],
                  h1,
                  ...
                  for (int index = 0;
                      ...
                      index++) ...[
                    RowTextFields(
                        designation[index], firm[index], index, 'Desi', 'Firm'),
                    h0P8,
                  ],
                  h1,
  ...
  Widget practiceField(String item, int index, String hintText) {
    return Row(
      children: [
        Expanded(
          flex: 9,
  ...
  Widget RowTextFields(String item1, String item2, int index, String hintText1,
      String hintText2) {
    return Row(
      children: [
        Expanded(
