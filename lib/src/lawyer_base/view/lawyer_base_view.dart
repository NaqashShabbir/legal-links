...
import 'pages/dashboard/view/lawyer_home_view.dart';

class LawyerBaseView extends StatefulWidget {
  static String route = "/lawyerBaseView";
  const LawyerBaseView({super.key});

  @override
  State<LawyerBaseView> createState() => _LawyerBaseViewState();
}

class _LawyerBaseViewState extends State<LawyerBaseView> {
